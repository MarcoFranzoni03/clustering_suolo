...
def plot_cluster2_focused_validation(df_map, df_medoids, df_c2_samples, x_coord, y_coord):
    # ==============================================================================
    # PLOT VALIDATION MAP: FOCUS ON CLUSTER 2 (2 POINTS)
    # ==============================================================================
    ...
    # Link only the Cluster 2 Medoid to its 2 specific control points
    ...
    ax.set_title(
        "Capitanata Management Zones: Cluster 2 Multi-Point Robustness Validation",
        fontsize=14,
        fontweight="bold"
    )
