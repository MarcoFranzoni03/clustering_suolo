...
def plot_spatial_validation_map(df_map, cluster_pairs, x_coord, y_coord):
    # ==============================================================================
    # PLOT DEFINITIVE VALIDATION MAP
    # ==============================================================================
    print("Status: Generating validation map...")
    ...
    # Style
    ax.set_title(
        "Capitanata Management Zones: Spatial Robustness Validation",
        fontsize=14,
        fontweight="bold"
    )
    ...
    ax.legend(
        handles,
        labels,
        title="Management Zone & Validation",
        loc="upper right"
    )
