...
def audit_random_points_profiles(cluster_pairs):
    # ==============================================================================
    # 1. PRINT AND VERIFY ASSIGNED CLUSTER IDS FOR EACH RANDOM POINT
    # ==============================================================================
    ...
    # ==============================================================================
    # 2. PRINT HYDRAULIC PARAMETERS FOR THE 4 RANDOM PAIRED POINTS
    # ==============================================================================
    ...
    for c_id in sorted(cluster_pairs.keys()):
        ...
        if not random_profile.empty:
            ...
            print(f"Warning: Profile for random point in Cluster {c_id} is empty!")