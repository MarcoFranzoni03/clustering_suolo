...
def extract_cluster2_control_data(unique_points, df_aquacrop_mappa):
    # ==============================================================================
    # 1. REGIONAL DISTANCE CONTROL POINTS (CLUSTER 2)
    # ==============================================================================
    ...
    # Extract exactly 2 random points from the intermediate tier (index 1000 to 2000)
    df_c2_samples = c2_points_sorted.iloc[1000:2000].sample(n=2, random_state=4)

    print("--- 2 RANDOM CONTROL POINTS FOR CLUSTER 2 ---")
    ...
    # ==============================================================================
    # 2. PRINT HYDRAULIC PARAMETERS FOR THE 2 CLUSTER 2 CONTROL POINTS
    # ==============================================================================
